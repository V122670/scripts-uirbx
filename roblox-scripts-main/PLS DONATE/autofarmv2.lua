...
local Flux = loadstring(game:HttpGet"https://raw.githubusercontent.com/tzechco/roblox-scripts/main/UI/flux.lua")()
local win = Flux:Window("PLS DONATE PANEL", "by V12#2670", Color3.fromRGB(0, 128, 0), Enum.KeyCode.RightShift)
...
local sValues = {true, 30, true, 0, "0.196078, 0.803922, 0.196078", 5, false, "", "Disabled", {"Thank you", "Thanks!", "ty :)", "tysm!"}, false, "GOAL: $C / $G", false, "your text here", "1, 1, 1", true, false, {"Please donate", "I'm so close to my goal!", "donate to me", "please"}, 300, 60, false, 3, false, true, false, false, false, false, "GothamBlack", 90, true}
